...
def run_pipeline(session: RAGSession, question: str) -> RAGResponse:
    ...
    try:
        ...
        # ADDED: Validate context block to catch retrieval issues early
        # This helps identify chunking/retrieval problems that would lead to poor answers
        if not context_block or len(context_block.strip()) < 10:
            ...
            trace.log_context_warning(f"Minimal context: {len(context_block)} chars")
